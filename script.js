...
document.addEventListener('DOMContentLoaded', () => {
    const hamBarbtn = document.querySelector('.ham-barbtn');

    if (hamBarbtn) {
        hamBarbtn.addEventListener('click', function() {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const sliderValue = document.getElementById('slider-value');  // Corrected ID here

    if (slider && sliderValue) {
        // Ensure initial value is displayed
        sliderValue.textContent = `Price: $${slider.value}`;
